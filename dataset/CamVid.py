...
import pandas as pd
import numpy as np
from utils import get_CamVid_label_info, one_hot_it, RandomCrop, reverse_one_hot, one_hot_it_v11, one_hot_it_v11_dice,\
...
class CamVid(torch.utils.data.Dataset):
    def __init__(self, image_path, label_path, csv_path, scale, loss='dice', mode='train'):
        ...
        self.label_info = get_CamVid_label_info(csv_path)
        # resize
...
if __name__ == '__main__':
    ...
    from utils import reverse_one_hot, get_CamVid_label_info, colour_code_segmentation, compute_global_accuracy

    label_info = get_CamVid_label_info('/data/sqy/CamVid/class_dict.csv')
